...
export function inputClass(className = '') {
  return cx(
    ...
    'focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-500',
    className
  )
}
...
export function Button({
  ...
  const variants = {
    primary: 'border border-blue-600 bg-blue-600 text-white shadow-sm hover:bg-blue-700 disabled:border-slate-300 disabled:bg-slate-200 disabled:text-slate-500',
    secondary: 'border border-slate-300 bg-white text-slate-700 shadow-sm hover:border-blue-300 hover:text-blue-700 disabled:text-slate-400',
  ...
  return (
    <button
      ...
      className={cx(
        'inline-flex min-h-10 items-center justify-center gap-2 rounded-lg px-3.5 py-2 text-sm font-semibold transition disabled:cursor-not-allowed',
        variants[variant],
        className
      )}
    >
...
export function tableClass() {
  return 'w-full min-w-[760px] border-separate border-spacing-0 text-left text-sm'
}

export function thClass() {
  return 'border-b border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-semibold text-slate-500'
}

export function tdClass(className = '') {
  return cx('border-b border-slate-100 px-3 py-3 text-slate-700', className)
}
